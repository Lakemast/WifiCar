...
public class HomeFragment extends Fragment {
    ...
    private View view;
    private Button accelerateButton, brakeButton;
        ...
        client.setCallback(new MqttCallback() {
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                if (topic.equals("mycustomtopic1")) {
                    ...
                    //String messageJSON = message.toString().replace("\"","\'");
                    ...
                    if (battery_double < 35) batteryTextView.setTextColor(Color.RED);
                    else batteryTextView.setTextColor(Color.GREEN);
                    obstacleTextView.setText(recievedJSON.getString("obstacle"));
                    int distance = Integer.valueOf(recievedJSON.getString("distance"));
                    if(distance<16) distanceTextView.setTextColor(Color.RED);
                    else distanceTextView.setTextColor(Color.GREEN);
    ...
    private void verifyConnection() {
        ...
        final Runnable a = new Runnable() {
            public void run() {
                ...
                if (pahoMqttClient.mqttAndroidClient.isConnected()) {
                    msg_new = "Connected.";
                    brokerStatus_TextView.setTextColor(0xFF00FF00); //Green if connected
